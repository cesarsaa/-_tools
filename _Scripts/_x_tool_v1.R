...
## ------------------------------------------------------- #
# Lectura de csv 
x_files <- read.csv("C:/Users/csaavedra/Downloads/IKI/IKI/web_iki.csv")
...
# write.csv(web_data, paste0("D:/OneDrive - CGIAR/Documents/GitHub/XX_tool/_Results/iki_web_2",Sys.Date(),".csv"), quote = T)
#
web_data <- web_data %>% 
...
#
write.csv(web_data, paste0("D:/OneDrive - CGIAR/Documents/GitHub/XX_tool/_Results/webscrapping_",Sys.Date(),".csv"))
write.csv(web_iki_bigram, paste0("D:/OneDrive - CGIAR/Documents/GitHub/XX_tool/_Results/bigram_web_",Sys.Date(),".csv"),quote = T)
